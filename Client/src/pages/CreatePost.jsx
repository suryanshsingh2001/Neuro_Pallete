  ...
  return (
    <section className="max-w-7xl mx-auto">
       <div>
            ...
            Showcase the power of AI and share your unique creation through DALL-E AI.</p>
        </div>
    ...
    <div className="mt-10">
        <p className="mt-2 text-[#666e75] text-[14px]">Join the conversation - post your machine-generated art for all to see</p>
        <button
            type = "submit"
